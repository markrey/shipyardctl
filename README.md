...
```sh
> wget https://github.com/30x/shipyardctl/releases/download/v1.3.0/shipyardctl-1.3.0.darwin.amd64.go1.7.tar.gz
> tar -xvf shipyardctl-1.3.0.darwin.amd64.go1.7.tar.gz
